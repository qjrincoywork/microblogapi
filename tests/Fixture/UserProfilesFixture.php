...
class UserProfilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'suffix' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'gender' => ['type' => 'integer', 'length' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '0-female; 1-male;', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'gender' => 1,
                'deleted' => 1,
                'created' => '2020-04-20 11:46:34',
                'modified' => '2020-04-20 11:46:34',
            ],
        ];
        parent::init();
    }
