...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_online' => ['type' => 'integer', 'length' => 5, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '0-offline; 1-online; 2-pending_activation;', 'precision' => null, 'autoIncrement' => null],
        'deleted' => ['type' => 'integer', 'length' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_online' => 1,
                'deleted' => 1,
                'created' => '2020-04-17 08:01:12',
                'modified' => '2020-04-17 08:01:12',
            ],
        ];
        parent::init();
    }
